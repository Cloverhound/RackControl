...
ActiveRecord::Schema.define(version: 2019_02_21_033715) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "device_labs", force: :cascade do |t|
    t.integer "device_id"
    t.integer "lab_id"
    t.integer "config_id"
  ...
  create_table "vmware_device_labs", force: :cascade do |t|
    t.integer "vmware_device_id"
    t.integer "lab_id"
  ...
  create_table "vmware_devices", force: :cascade do |t|
    t.string "vm_name"
